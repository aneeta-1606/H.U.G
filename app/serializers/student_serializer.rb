class StudentSerializer < ActiveModel::Serializer
  ...
  attributes :id, :first_name, :class_name, :school_id, :school_name, :school_phone, :user_id,
             :zip_code, :clarity_email, :clarity_person_name, :clarity_phone,
             :clarity_alt_phone, :updated_at, :notes, :active, :why_inactive,:second_grade_year,
             :third_grade_year, :fifth_grade_year, :other_program_notes, :control_group,
             :num_other_programs, :grade, :vol_name, :vol_email, :vol_phone, :vol_ids, :vol_list, :scores
  ...
  def num_other_programs
    num_other_programs = 99
    num_other_programs
  end
